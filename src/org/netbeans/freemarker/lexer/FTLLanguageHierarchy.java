...
public class FTLLanguageHierarchy extends LanguageHierarchy<FTLTokenId> {
    ...
    private static void init() {
        tokens = Arrays.<FTLTokenId>asList(new FTLTokenId[]{
                    ...
                    new FTLTokenId("STATIC_TEXT_WS", "default", FMParserConstants.STATIC_TEXT_WS), 
                    new FTLTokenId("STATIC_TEXT_NON_WS", "default", FMParserConstants.STATIC_TEXT_NON_WS),
                    new FTLTokenId("STATIC_TEXT_FALSE_ALARM", "default", FMParserConstants.STATIC_TEXT_FALSE_ALARM),
                    new FTLTokenId("DOLLAR_INTERPOLATION_OPENING", "interpolation", FMParserConstants.DOLLAR_INTERPOLATION_OPENING),
                    ...
                    //new FTLTokenId("PRINTABLE_CHARS", "braces", FMParserConstants.PRINTABLE_CHARS),
                    //new FTLTokenId("FALSE_ALERT", "braces", FMParserConstants.FALSE_ALERT),
                    //new FTLTokenId("OUTPUT_ESCAPE", "braces", FMParserConstants.OUTPUT_ESCAPE),
        });
